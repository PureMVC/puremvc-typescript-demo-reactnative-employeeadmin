...
import {IDelegate} from "./view/interfaces/IDelegate";
...
export class ApplicationFacade extends Facade {
  ...
  public register(delegate: IDelegate, type: string) {
    this.sendNotification(ApplicationConstants.REGISTER, delegate, type);
  }

  public unregister(type: string) {
    this.sendNotification(ApplicationConstants.UNREGISTER, null, type);
  }
}
